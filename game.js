// ==============================================
// 🔥 腾讯云联网功能（已自动加好，不影响任何游戏）
// ==============================================
const tcb = window.cloudbase;
const app = tcb.init({
  env: "game-d3gu44vc2f9892a18"
});
...
async function syncPlayerToCloud() {
  ...
  try {
    const playerData = {
      id: gameData.player.name + "_" + gameData.roomCode,
    ...
    console.log("✅ 玩家已上线：" + gameData.player.name);
  } catch (err) {}
}
